...
Предлагаемый нами продукт исполняет три основных функции: -сбор и хранение данных о платежнвх операциях, -калькуляция всез платежных операций. -сведение отчета об операциях при запросе. Туким образом, приложение содержит 3 основных модуля: 
